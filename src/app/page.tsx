...
export default function Home() {
  return (
    <main className="min-h-screen flex flex-col justify-center items-center bg-gradient-to-b from-blue-200 to-purple-300">
      <SignedOut>
        <div className="text-center p-6 rounded-lg shadow-lg bg-white/80">
